...
class OrderModel extends Model
{
    ...
    {
        return $this->where($where)->limit($offset, $limit)->order('order_id desc')->select();
    }
    ...
    public function editProducttitle($param)
    {
        try{
            ...
            if(false === $result){
                ...
                return msg(1, url('text/test'), '编辑成功');
            }
        }catch(\Exception $e){
            return msg(-2, '', $e->getMessage());
        }
     ...
     * @param $id
     */
    public function delProducttitle($order_id)
    {
        try{
